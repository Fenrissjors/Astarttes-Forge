(function(){
  ...
  const geometries=Object.freeze({
    'space-wolves': Object.freeze({"titleBoxPx":{"x":310,"y":286,"width":1864,"height":224},"canvasPx":{"width":2480,"height":3508},"titlePaddingPx":{"top":21,"right":76,"bottom":21,"left":76},"titleTypography":{"maxTitlePt":15.0,"minTitlePt":8.5,"kickerPt":6.5,"pointsPt":9.0,"singleLine":true},"panelBoxPx":{"x":292,"y":598,"width":1896,"bottom":3490}}),
  ...
  window.ASTARTES_FRAME_GEOMETRY_LIBRARY={version:'3.0.54',contract:CONTRACT,geometries,resolve,manifestPath,boxToMm,pxToMmX,pxToMmY};
})();
