(function(){
  ...
  window.ASTARTES_FRAME_GEOMETRY_LIBRARY={version:'4.0.1-tyranids-artwork',contract:CONTRACT,geometries,resolve,manifestPath,boxToMm,pxToMmX,pxToMmY};
})();
