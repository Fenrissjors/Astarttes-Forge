(function(){
  ...
  window.ASTARTES_FRAME_GEOMETRY_LIBRARY={version:'4.0.3-tyranids-master-aligned',contract:CONTRACT,geometries,resolve,manifestPath,boxToMm,pxToMmX,pxToMmY};
})();
