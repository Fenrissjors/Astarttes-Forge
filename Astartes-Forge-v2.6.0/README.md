# Astartes Forge v2.6.0 — Dark Angels Module
...
## v2.4.6 scope fix
`renderDataQualityDashboard` is restored to top-level scope. The import success path no longer throws a false ReferenceError after a valid roster import.
